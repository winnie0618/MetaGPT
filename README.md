...
🚀 Jul. 23, 2026: Added GovTrace-Agent thesis prototype updates for traceable multi-agent government service workflows, including retrieval comparison, multi-agent ablation evaluation, trace lookup, and a dependency-free local web demo. See [change summary](docs/government_service_thesis/CHANGELOG.md).
